...
#
# TODO: Replace v-rest and V-lang REST API framework with Idris2 ABI proofs and Zig FFI with actual values.

{
  description = "v-rest — RSR-compliant project";
    ...
    flake-utils.lib.eachSystem [ "x86_64-linux" "aarch64-linux" ] (system:
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            echo "TODO: Add build commands for v-rest"
          '';
          ...
          meta = with pkgs.lib; {
            description = "V-lang REST API framework with Idris2 ABI proofs and Zig FFI";
            homepage = "https://github.com/hyperpolymath/v-rest";
