...
// Replace v-rest, V Rest — See README.adoc for details., just run, V Rest started successfully. with actuals
= v-rest — Quick Start for Users
:toc:
:toclevels: 2

== What is v-rest?

V Rest — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./v-rest-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/v-rest/wiki
