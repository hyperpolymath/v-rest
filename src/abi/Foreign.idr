...
module VApi.ABI.Foreign

import VApi.ABI.Types
import VApi.ABI.Layout
...
export
%foreign "C:vapi_process, libvapi"
...
||| Free C string
export
%foreign "C:vapi_free_string, libvapi"
prim__freeString : Bits64 -> PrimIO ()

||| Get string result from library
export
%foreign "C:vapi_get_string, libvapi"
...
||| Process array data
export
%foreign "C:vapi_process_array, libvapi"
...
export
%foreign "C:vapi_last_error, libvapi"
...
||| Get library version
export
%foreign "C:vapi_version, libvapi"
...
export
%foreign "C:vapi_build_info, libvapi"
...
||| Register a callback
export
%foreign "C:vapi_register_callback, libvapi"
...
export
%foreign "C:vapi_is_initialized, libvapi"
