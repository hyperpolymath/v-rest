...
// Replace v-rest, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= v-rest — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining v-rest for
...
* Upstream: https://github.com/hyperpolymath/v-rest/issues
